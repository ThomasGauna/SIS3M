    ...
    <div class="page">
                ...
                <ul class="list-inline navbar-contact-list">
                  ...
                  <li>
                    <div class="unit unit-spacing-xs align-items-center">
                      ...
                      <div class="unit-body">
                        <a href="tel:1164189217" onClick="gtag('event', 'Clic llamada', { event_category: 'Clic llamada', event_action: 'Clic'});">(011) 15-6418-9217</a>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="unit unit-spacing-xs align-items-center">
                      ...
                      <div class="unit-body">
                        <a href="tel:1162080684" onClick="gtag('event', 'Clic llamada', { event_category: 'Clic llamada', event_action: 'Clic'});">(011) 15-6208-0684</a>
                      </div>
                    </div>
                  </li>
                </ul>
              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <div class="dropdown">
                      <button class="dropbtn"><a href="https://mundogenerador.com/comercial.html">Comercial <i class="fa fa-caret-down"></i></a></button>
                      <div class="dropdown-content">
      ...
      <section class="section main-section parallax-scene-js"
        ...
        <div class="decorate-layer">
          <div class="layer-1">
            <div class="layer" data-depth=".20"><img alt="Imagenes triangulos" height="266" src="images/parallax-item-1-563x532.png" width="563"/>
            </div>
          </div>
          <div class="layer-2">
            <div class="layer" data-depth=".30"><img alt="Imagenes triangulos" height="171" src="images/parallax-item-2-276x343.png" width="276"/>
            </div>
          </div>
          <div class="layer-3">
            <div class="layer" data-depth=".40"><img alt="Imagenes triangulos" height="72" src="images/parallax-item-3-153x144.png" width="153"/>
            </div>
          </div>
          <div class="layer-4">
            <div class="layer" data-depth=".20"><img alt="Imagenes triangulos" height="37" src="images/parallax-item-4-69x74.png" width="69"/>
            </div>
          </div>
          <div class="layer-5">
            <div class="layer" data-depth=".40"><img alt="Imagenes triangulos" height="37" src="images/parallax-item-5-72x75.png" width="72"/>
            </div>
          </div>
        </div>
      </section>
          ...
          <section class="section section-md fondo">
            <h2 class="tituloSistema">Sistema de Stock</h2>
            <div class="buscador-producto">
              <input type="text" id="codigoBusqueda" placeholder="Buscar por código de producto">
              <button onclick="buscarProducto()">Buscar</button>
            </div>
    
            <nav>
                <button onclick="mostrarCategoria('Stock Service')" class="active">Stock Service</button>
                <button onclick="mostrarCategoria('Stock General')">Stock General</button>
                <button onclick="mostrarCategoria('Stock Repuesto')">Stock Repuesto</button>
                <a href="registro_movimiento.php" class="btn-logout">Historial</a>
            ...
            <script>
                function mostrarCategoria(categoria) {
                    ...
                    fetch(`obtener_actualizar_datos.php?categoria=${categoria}`) 
                    .then(response => response.text())
                    .then(data => {
                        document.getElementById('tabla-stock').innerHTML = data;
                    })
                    .catch(error => {
                ...
                function actualizarStock(codigo, esIngreso) {
                ...
                const cantidadFinal = esIngreso ? cantidad : -cantidad;

                fetch('obtener_actualizar_datos.php', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded',
                    },
                    body: `codigo=${codigo}&cantidad=${cantidadFinal}`,
                })
                .then(response => response.text())
                .then(data => {
                    console.log(data);
                    const stockElement = document.getElementById(`stock-${codigo}`);
                    const stockActual = parseInt(stockElement.textContent);
                    stockElement.textContent = stockActual + cantidadFinal;
                })
                .catch(error => {
                    console.error('Error:', error);
                });
            }
                mostrarCategoria('Stock Service');
    
                function buscarProducto() {
                const codigo = document.getElementById('codigoBusqueda').value.trim();
                if (codigo === '') return;
    
                fetch(`obtener_actualizar_datos.php?busqueda_codigo=${codigo}`)
                  .then(response => response.text())
                  .then(data => {
                    document.getElementById('tabla-stock').innerHTML = data;
                  })
