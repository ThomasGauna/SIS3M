              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <div class="dropdown">
                      <button class="dropbtn"><a href="https://www.facebook.com/mundogenerador" target="blank">Clientes <i class="fa fa-caret-down"></i></a></button>
                      <div class="dropdown-content">
                    ...
                    <div class="dropdown">
                      <button class="dropbtn"><a href="https://mundogenerador.com/prensa.html">Prensa</a></button>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row justify-content-center"> 
            <div class="col-xl-8 col-12">
              <div class="main-decorated-box text-center text-xl-left">
                <p class="text-white  wow slideInRight" data-wow-delay=".3s"><span class="big font-weight-bold d-inline-flex "><img alt="Logo Mundo Generador" height="211" src="./images/logo-11anios.png" width="534" /></span></p>
              </div>
            </div>
          ...
          <section class="section section-md fondo">
            ...
            <script>
                function mostrarCategoria(categoria) {
                  ...
                  function actualizarStock(codigo, cantidad, button) { 
                      ...
                      .then(data => {
                          console.log(data); 
                          let stockElement = button.parentNode.querySelector('span'); 
